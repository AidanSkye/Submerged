...
public class SubmergedSundownAidanEnterprisesMapEffect extends SubmergedAidanEnterprisesMapEffect {
    public SubmergedSundownAidanEnterprisesMapEffect(Identifier identifier) {
        super(identifier);
    }
