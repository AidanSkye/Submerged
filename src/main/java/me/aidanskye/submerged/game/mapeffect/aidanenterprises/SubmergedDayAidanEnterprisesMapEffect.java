...
public class SubmergedDayAidanEnterprisesMapEffect extends SubmergedAidanEnterprisesMapEffect {
    public SubmergedDayAidanEnterprisesMapEffect(Identifier identifier) {
        super(identifier);
    }
